...
def analyze_token_efficiency(base_dir):
    ...
    tasks = {
        "写单章正文": [
            ...
            "00_通用模板/01_写作规则/00_通用写作规则.md",
            "00_通用模板/01_写作规则/00_文风_天骄崛起流.md",
            "01_小说数据/00_苍玄/01_设定/00_主角档案.md",
            "01_小说数据/00_苍玄/01_设定/00_小说概念.md",
            "01_小说数据/00_苍玄/03_规划/01_第01部/01_卷01/规划_卷01_章0001.md",
            "01_小说数据/00_苍玄/02_数据库/07_人物/07_人物_叶云生.md",
            "01_小说数据/00_苍玄/04_状态/出场对象台账.md"
        ],
        "生成单卷大纲": [
            ...
            "01_小说数据/00_苍玄/03_势力组织/03_势力组织.md",
            "01_小说数据/00_苍玄/04_资源/04_资源.md"
        ],
        "云端回填分割": [
...
def analyze_scalability_10m_words():
    ...
    print(f"    - 状态台账 (`04_状态/出场对象台账.md`): 涉及 {characters} 角色, 预估行数 {state_ledger_lines:,} 行 | 预估 Token: ~{estimate_tokens('a'*(state_ledger_lines*80)):,} Tokens")
